...
#define MMC_DDR  DDRB
//XXX
#define MMC_PORT_CS PORTD
#define MMC_DDR_CS  DDRD

#define SPI_MISO	PB4		//DataOut of MMC 
#define SPI_MOSI	PB3		//DataIn of  MMC
#define SPI_CLK  	PB5		//Clock of MMC
//XXX #define MMC_CS		PB2		//ChipSelect of MMC
#define MMC_CS		PD4		//ChipSelect of MMC
#define WIZ_CS    PB2   //ChipSelect of Wiznet Chip
